...
table.addEventListener('click', (e) => {
  if (e.target.classList.contains('get-pricing-table-btn-d')) {
    ...
    const url = `delete.html?id=${encodeURIComponent(id)}&name=${encodeURIComponent(name)}&date=${encodeURIComponent(date)}`;
